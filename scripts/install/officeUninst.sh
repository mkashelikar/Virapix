...
echo "IMPORTANT! You have chosen $1 to uninstall OpenOffice from. Press Y to confirm or any other key to abort."
read ans
...
alias unopkgrs='$NEWROOT/usr/bin/unopkg remove --shared'
